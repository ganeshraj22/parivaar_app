        ...
        def preprocess_data(ambulance_df):
          ...
          def replace_values(ambulance_df):
              for col in ambulance_df.columns:
                  ...
                  if isinstance(ambulance_df.at[0, col], str) and (ambulance_df.at[0, col].startswith('Ambulance') or ambulance_df.at[0, col].startswith('REC') or ambulance_df.at[0, col].lower.find('bolero')):
