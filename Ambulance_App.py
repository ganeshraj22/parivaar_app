...
start_date=st.slider.date_input("Start Date",min_value=datetime(2020,1,1),max_value=date.today())
end_date=st.slider.date_input("End Date",min_value=start_date,max_value=date.today())
