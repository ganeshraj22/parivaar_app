...
if page=='District Level':
    def get_data(selected_district,date_range,level_of_detail,sheet):
        ...
        if (Ambulance_By_Month['Total Distance Covered'].count()==0):
           return False, fig1, fig2, fig3, fig4, min_date, max_date,Number_Of_PHC,Summary_Total,locations_gen
        else:
            return True, fig1, fig2, fig3, fig4, min_date, max_date,Number_Of_PHC,Summary_Total,locations_gen

    col1,col2,col3,col4,col5=st.columns([1,1,1,1,1])
    with col1:
        selected_district=st.selectbox('**Select a district**',Districts)
    with col2:
        location=st.multiselect('**Select a location**',locations_gen)
    with col3:
    ...
    (val,fig1,fig2,fig3,fig4,min_date,max_date,Number_Of_PHC,Summary_Total,locations_gen)=get_data(selected_district,date_range,level_of_detail,sheet)
...
if page=='Overall Summary':
    ...
    def get_data_full(date_range,level_of_detail,_sheet):
        ...
        if (Ambulance_By_Month_full['Total Distance Covered(KM)'].count()==0):
            return False, fig1, fig2, fig3, fig4, Ambulance_By_Month_full,Total_Number_Of_PHC,Summary_Total_full,min_date_full,max_date_full
        else:
            return True, fig1, fig2, fig3, fig4, Ambulance_By_Month_full,Total_Number_Of_PHC,Summary_Total_full,min_date_full,max_date_full
    ...
    (val,fig5,fig6,fig7,fig8,summary_df,Total_Number_Of_PHC,Summary_Total_full,min_date_full,max_date_full)=get_data_full(date_range,level_of_detail,sheet)
