...
def get_data(selected_district,date_range,level_of_detail,sheet):
    ...
    Ambulance_By_Month['Month']=str(pd.to_datetime(Ambulance_By_Month['Date']).dt.month)
    Ambulance_By_Month['Year']=str(pd.to_datetime(Ambulance_By_Month['Date']).dt.year)
