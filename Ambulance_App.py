...
if page=='District Level':
    ...
    with col3:
        dt_range=st.date_input('**Enter date range**',value=(min_date,datetime(2024,7,31)),min_value=min_date, max_value=datetime(2024,7,31),key='dt_range',format='DD/MM/YYYY')
