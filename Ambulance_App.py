...
def get_data(selected_district,date_range,level_of_detail,sheet):
    ...
    plt.title(f'{selected_district.split("-")[0]} - Kilometers Driven/Persons Served By {level_of_detail}')
    ...
    plt.gca().add_patch(plt.Rectangle((-0.5,-0.5),1,1,fill=False,edgecolor='black'))
