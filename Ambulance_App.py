...
if page=='District Level':
    ...
    if location_global==[]:
        ...
        Ambulance_By_Month[['Yrmo','Year']]=Ambulance_By_Month['Yrmo'].astype(str).str.replace(',','',regex=True).astype(int)
        st.write(Ambulance_By_Month[:num_rows].sort_values(by='Yrmo',ascending=False))
