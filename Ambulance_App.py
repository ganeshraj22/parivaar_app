...
if page=='District Level':
    ...
    with col3:
        date_range_dt=st.date_input('**Enter date range**',value=(datetime(2023,1,1),date.today()),min_value=min_date, max_value=date.today(),key='date_range_dt',format='DD/MM/YYYY')
    with col2:
