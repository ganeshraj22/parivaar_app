...
def get_data(selected_district,date_range,level_of_detail,sheet):
    ...
    Ambulance_By_Month=Ambulance_By_Month.groupby(['Date'])[['Total Distance Covered','Total Patients Served','Yrmo']].
        agg({'Total Distance Covered':sum,'Total Patients Served':sum,'Yrmo':avg})
