...
if page=='District Level':
    ...
    (val,fig1,fig2,fig3,fig4,min_date,max_date,Number_Of_PHC,Summary_Total,locations,location_global,a_test)=get_data(selected_district,date_range,level_of_detail,sheet,location_global,locations)
