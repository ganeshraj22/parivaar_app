...
if page=='District Level':
    ...
    with col3:
        date_range=st.date_input('**Enter date range**',min_value=datetime(2021,5,1),max_value=date.today(),key='date_range',format='DD/MM/YYYY')
    with col4:
    ...
    with col2:
        location=st.dropdown('**Select a location**', locations, placeholder='All locations')
