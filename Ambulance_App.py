...
def get_data(selected_district,date_range,level_of_detail,sheet):
    ...
    Ambulance_By_Month['Date']=Ambulance_By_Month['Date'].dt.date.strftime('%b %Y')
    Ambulance_By_Month['Yrmo']=Ambulance_By_Month['Year']+Ambulance_By_Month['Month']
    Ambulance_By_Month=Ambulance_By_Month.groupby(['Yrmo','Date'])[['Total Distance Covered','Total Patients Served']].sum()
